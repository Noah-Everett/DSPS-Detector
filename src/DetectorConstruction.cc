...
void DetectorConstruction::place_surface( G4ThreeVector t_axis_normal ) {
    ...
    *rotationMatrixTurn *= *rotationMatrix;
    ...
    G4ThreeVector translation_initial_DSPD( 0,0,0);
    m_directionSensitivePhotoDetector->place( rotationMatrix, *rotationMatrix * (translation_initial_DSPD ), m_detector_medium->get_logicalVolume(), true );
