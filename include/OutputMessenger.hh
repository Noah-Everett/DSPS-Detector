...
class OutputMessenger : public G4UImessenger
{
    public:
        ...
        G4bool   get_medium_hits_direction_save                   () const;
        ...
        void set_medium_hits_direction_save                   ( G4bool   value );
    ...
    protected:
        ...
        G4UIcmdWithABool    * m_command_medium_hits_direction_save                   { nullptr };
        ...
        G4UIcmdWithABool    * m_command_primary_direction_save                       { nullptr };
        ...
        G4UIcmdWithABool    * m_command_photon_direction_save                        { nullptr };
        ...
        G4bool   m_variable_medium_hits_direction_save                   { false         };
        ...
        G4bool   m_variable_primary_direction_save                       { false         };
        ...
        G4bool   m_variable_photon_direction_save                        { false         };
