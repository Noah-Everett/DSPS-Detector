...
def split_data(all_h5_paths, n_test, n_val, seed):
    ...
    return ([all_h5_paths[i] for i in train_idx],
            [all_h5_paths[i] for i in test_idx],
            [all_h5_paths[i] for i in val_idx])

def main():
    parser = argparse.ArgumentParser(description='Generate ML data grids')
